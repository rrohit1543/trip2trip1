...
import { X, ShieldAlert, Lock, Mail, KeyRound, AlertTriangle, ArrowRight } from 'lucide-react';
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/90 backdrop-blur-md overflow-y-auto">
      <div className="relative w-full max-w-md bg-black border-2 border-red-600 rounded-3xl shadow-2xl overflow-hidden flex flex-col my-8">
        {/* Header */}
        <div className="p-5 bg-neutral-950 border-b border-red-900/60 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-lg font-black text-white tracking-tight">Super Admin Portal</h3>
              <p className="text-xs text-red-400 font-semibold uppercase tracking-wider">Separate Restricted Authentication</p>
            </div>
          </div>
