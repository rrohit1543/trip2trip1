...
export default function Navbar({
  ...
  return (
    <div className="w-full sticky top-0 z-50 font-sans bg-white">
      ...
      {/* Main RedBus-Identical Header Navbar (Pure White) */}
      <header className="bg-white border-b border-slate-200 shadow-sm transition-colors duration-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between gap-4">
          ...
          >
            <div className="relative flex items-center justify-center w-11 h-11 rounded-2xl bg-white border-2 border-red-600 shadow-md group-hover:scale-105 transition-transform duration-300">
            ...
            <div>
              ...
              <p className="text-[10px] text-slate-500 font-semibold hidden sm:block">Group Trips & Live Telemetry</p>
            </div>
          </Link>
          ...
          <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                <div className="flex items-center gap-2.5 bg-slate-50 border border-slate-200 px-3 py-1.5 rounded-2xl">
                  ...
                  <div className="text-left hidden sm:block">
                    ...
                    <div className="text-[10px] text-red-600 font-bold capitalize">
                ...
                <button
                  onClick={onLogout}
                  title="Sign Out"
                  className="p-2 rounded-xl bg-slate-100 border border-slate-200 hover:border-red-600 text-slate-600 hover:text-red-600 transition"
                >
            ...
            <button
              ...
              className="p-2 rounded-full bg-slate-100 border border-slate-200 hover:border-red-600 text-red-600 transition flex items-center gap-1.5 text-xs font-bold"
